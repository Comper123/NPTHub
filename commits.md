...
* Разделить страницу репозитория на составные части (сделать nav)
    ...
    - настройки проекта
        ...
        + добавление тех кто может просматривать (приватный реп но есть доступ определеным людям)
...
### commit 19.11.2024 (11:00 - 12:00, 12:30 - 14:30)
