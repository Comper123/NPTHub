...
* Запрет на изменение проекта с пустым названием (пробелы) + символы
...
* знаки (' " = и тд) при поиске выдют пустой результат (надо ничего не найдено отображать)
...
* Скрытие длинного описания > 400 символов
* Ограничить описание по длинне
* Добавить кнопку открыть комментарий
